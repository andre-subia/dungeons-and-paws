...
const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    "title.bottomRight": "READY TO DESCEND?",
    "title.runsHeader": "TOP RUNS",
    "title.runsEmpty": "NO RUNS YET",
    "title.runsEmptyHint": "Finish a run to appear here.",
  ...
  es: {
    ...
    "title.crest": "UNA VIDA · UNA RUN · DEJA TU HUELLA",
    ...
    "title.sansLine1": "El dungeon no perdona.",
    "title.sansLine2": "Tú tampoco.",
    "title.bottomLeft": "EL TABLERO NO ES AZAR. ES DESTINO.",
    "title.bottomRight": "¿LISTO PARA DESCENDER?",
    "title.runsHeader": "MEJORES RUNS",
    "title.runsEmpty": "AÚN NO HAY RUNS",
    "title.runsEmptyHint": "Termina una run para aparecer aquí.",
  ...
  pt: {
    ...
    "title.crest": "UMA VIDA · UMA RUN · DEIXE SUA MARCA",
    ...
    "title.bottomRight": "PRONTO PARA DESCER?",
    "title.runsHeader": "MELHORES RUNS",
    "title.runsEmpty": "AINDA NÃO HÁ RUNS",
    "title.runsEmptyHint": "Termine uma run para aparecer aqui.",
