...
const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    "map.close": "Close",
    "map.exploredFmt": "{percent}% revealed",
    "map.legend.you": "You",
    "map.legend.exit": "Exit",
    "map.legend.key": "Key",
    "map.legend.wall": "Rock",
    "map.legend.unexplored": "Fog",
    ...
    "reject.destination_wall": "Solid rock — try another way",
    "reject.destination_void": "There is no path here",
    "reject.path_blocked": "Path blocked by rock at ({x},{y})",
  ...
  es: {
    ...
    "map.button": "Mapa",
    "map.title": "Mapa del Dungeon",
    "map.close": "Cerrar",
    "map.exploredFmt": "{percent}% revelado",
    "map.legend.you": "Tú",
    "map.legend.exit": "Salida",
    "map.legend.key": "Llave",
    "map.legend.wall": "Roca",
    "map.legend.unexplored": "Niebla",
    ...
    "reject.destination_wall": "Roca sólida — busca otro camino",
    "reject.destination_void": "No hay camino aquí",
    "reject.path_blocked": "Camino bloqueado por roca en ({x},{y})",
  ...
  pt: {
    ...
    "map.button": "Mapa",
    "map.title": "Mapa do Dungeon",
    "map.close": "Fechar",
    "map.exploredFmt": "{percent}% revelado",
    "map.legend.you": "Você",
    "map.legend.exit": "Saída",
    "map.legend.key": "Chave",
    "map.legend.wall": "Pedra",
    "map.legend.unexplored": "Névoa",
    ...
    "reject.destination_wall": "Pedra sólida — tente outro caminho",
    "reject.destination_void": "Não há caminho aqui",
    "reject.path_blocked": "Caminho bloqueado por pedra em ({x},{y})",
